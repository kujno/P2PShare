...
{
    /// <summary>
    /// Interaction logic for Send_ReceiveWindow.xaml
    /// </summary>
    public partial class Send_ReceiveWindow : Window
    {
        private SendReceiveEnum _receiveSend;
        private int _filesCount;
        private int _i;
        private FileInfo[] _fileInfos;
        public bool Done { get; }
        
        public Send_ReceiveWindow(SendReceiveEnum receiveSend, FileInfo[] fileInfos)
        {
            InitializeComponent();
